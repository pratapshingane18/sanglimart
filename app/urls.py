...
urlpatterns = [
    ...
    # path('password_reset', auth_views.PasswordResetView.as_view(template_name='app/login.html',
    #  form_class = MyPasswordResetForm), name="password_reset"),
     
    path('passwordchange/', auth_views.PasswordChangeView.as_view(template_name
     ='app/passwordchange.html', form_class=MyPasswordChangeForm, success_url='/passwordchangedone/'), name='passwordchange'),
    ...
    (template_name='app/password_complete_done.html'), name='password_reset_complete'),
